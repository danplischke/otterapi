...
class Schema(BaseModel):
    ...
    prefixItems: Optional[List[Union[Schema, Reference]]] = None
    contains: Optional[Union[Schema, Reference]] = None  # New in 3.2
    
    # Object keywords
    properties: Optional[Dict[str, Union[Schema, Reference]]] = None
    additionalProperties: Optional[Union[Schema, Reference, bool]] = True
    patternProperties: Optional[Dict[str, Union[Schema, Reference]]] = None
    propertyNames: Optional[Union[Schema, Reference]] = None  # New in 3.2
    
    # String keywords
    format: Optional[str] = None
    contentMediaType: Optional[str] = None  # New in 3.2
    contentEncoding: Optional[str] = None  # New in 3.2
    ...
    if_: Optional[Union[Schema, Reference]] = Field(None, alias='if')  # New in 3.2
    then: Optional[Union[Schema, Reference]] = None  # New in 3.2
    else_: Optional[Union[Schema, Reference]] = Field(None, alias='else')  # New in 3.2
    dependentSchemas: Optional[Dict[str, Union[Schema, Reference]]] = None  # New in 3.2
