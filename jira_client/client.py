...
from ._client import BaseTheJiraCloudPlatformRESTAPIClient, BaseAPIError


class TheJiraCloudPlatformRESTAPIClient(BaseTheJiraCloudPlatformRESTAPIClient):
    """API client with customizable configuration.

    This class inherits from the generated BaseTheJiraCloudPlatformRESTAPIClient and can be
    ...
    released cleanly::
        ...
        with TheJiraCloudPlatformRESTAPIClient() as client:
            data = list_genes(client=client)

    Async context manager::

        async with TheJiraCloudPlatformRESTAPIClient() as client:
    ...
    Other examples::
        ...
        >>> client = TheJiraCloudPlatformRESTAPIClient(base_url="https://staging.api.example.com")
        >>> client = TheJiraCloudPlatformRESTAPIClient(max_retries=0)  # disable retry
        >>> client = TheJiraCloudPlatformRESTAPIClient(timeout=60.0, headers={"X-Request-ID": "abc"})
    """
...
Client = TheJiraCloudPlatformRESTAPIClient
Error = APIError

__all__ = ["APIError", "Client", "Error", "TheJiraCloudPlatformRESTAPIClient"]
